...
class JunctionTree:
    ...
    def _load_factors(self) -> None:
        ...
        Each factor is assigned to a **single** node in the clique tree, with the condition that **all** factor vars
        be included in the clique node vars.
        """
    ...
    def _incorporate_evidence(self, jt: nx.DiGraph, evidence: Dict[str,]) -> nx.DiGraph:
        """
